...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CloudFile - Secure cloud storage & file management" },
      { name: "description", content: "Premium cloud storage platform to upload, organize, sync and share files securely across devices." },
      { property: "og:title", content: "CloudFile - Secure cloud storage & file management" },
      { property: "og:description", content: "Premium cloud storage platform to upload, organize, sync and share files securely across devices." },
    ...
    links: [
      ...
      { rel: "apple-touch-icon", href: "/__l5e/assets-v1/8b6999f3-2012-4869-b1be-75d195b8abc5/cloudfile-logo-v2.png" },
